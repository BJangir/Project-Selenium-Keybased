...
public class RunTestCases {
	...
	public static List<Object[]> getTestCases() throws IOException {
		...
		// List<TestStepModel> testCaseModel =
		// actionUtil.getTestCaseModel(teststeps);
	...
	public static void beforeClass() throws IOException {
		if (Boolean.parseBoolean(reader.getKeyValue("START_BROWSER_FIRST"))) {
			WebDriverUtil driverUtil = new WebDriverUtil(reader.getKeyValue("BROWSER_TYPE"),
					reader.getKeyValue("DRIVER_PATH"));
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * driverUtil.openBrowser("http://xcelerator.ninja"); ExcelUtil util=new
		 * ExcelUtil(); //List<String[]> excelData =
		 * util.getExcelData(EXCEL_PATH, "Pages", "5");
		 * 
		 * List<String[]> testcaseData = util.getExcelDataBasedOnRunCol("",
		 * "Testcase", 6); ActionUtil actionUtil=new ActionUtil();
		 * List<TestStepModel> testCaseModel =
		 * actionUtil.getTestCaseModel(testcaseData);
		 * 
		 * 
		 * 
		 * 
